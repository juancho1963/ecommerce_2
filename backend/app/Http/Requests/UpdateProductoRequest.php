...
class UpdateProductoRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|max:255|unique:productos,name,'.$this->producto->id,
            'qty' => 'required|numeric',
            'price' => 'required|numeric',
            'color_id'=> 'required',
            'size_id'=> 'required',
            'desc'=> 'required|max:2000',
            'thumbnail'=> 'required|image|mimes:png,jpg,jpeg|max:2000',
            'first_image'=> 'image|mimes:png,jpg,jpeg|max:2000',
            'second_image'=> 'image|mimes:png,jpg,jpeg|max:2000',
            'third_image'=> 'image|mimes:png,jpg,jpeg|max:2000',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'price.numeric' => 'La cantidad debe ser un numero.',
